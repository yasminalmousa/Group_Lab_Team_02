...
public class CourseWorkJPanel extends javax.swing.JPanel {
    ...
    private void populateStudentData() {
        if (student != null) {
            ...
            jLabel12.setText("7 / 120"); // Example: completed / total credits
            jLabel14.setText("5"); // Example: number of enrolled courses
        }
    }
    ...
    private void loadCourseData() {
        ...
        if (student != null) {
            addCourseToTable("CS101", "Introduction to Programming", "3", "Fall 2024", "A");
            addCourseToTable("CS102", "Data Structures", "4", "Fall 2024", "B+");
            addCourseToTable("MATH201", "Calculus I", "3", "Spring 2025", "In Progress");
            addCourseToTable("ENG101", "English Composition", "3", "Spring 2025", "In Progress");
            addCourseToTable("PHYS201", "Physics I", "4", "Spring 2025", "In Progress");
        }
    }
