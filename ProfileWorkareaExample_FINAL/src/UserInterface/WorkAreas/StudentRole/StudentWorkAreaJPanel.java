...
import UserInterface.WorkAreas.StudentRole.StudentProfileJPanel;
...
public class StudentWorkAreaJPanel extends javax.swing.JPanel {
    ...
    private void initializeSampleData() {
        if (student != null && student.getCoursesEnrolled().isEmpty()) {
            ...
            // Set some basic info if not already set
    ...
    private void jButton4IdentifyResourceAssetsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4IdentifyResourceAssetsActionPerformed
        ...
        ((CardLayout) CardSequencePanel.getLayout()).show(CardSequencePanel, "CourseWork");                 
    }//GEN-LAST:event_jButton4IdentifyResourceAssetsActionPerformed

    private void btnMyProfileActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnMyProfileActionPerformed
        StudentProfileJPanel profilePanel = new StudentProfileJPanel(student, CardSequencePanel);
        CardSequencePanel.add("StudentProfile", profilePanel);
        ((CardLayout) CardSequencePanel.getLayout()).show(CardSequencePanel, "StudentProfile");
}//GEN-LAST:event_btnMyProfileActionPerformed

    private void jButton10ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton10ActionPerformed
        GraduationAuditJPanel graduationPanel = new GraduationAuditJPanel(business, student, CardSequencePanel);
        CardSequencePanel.add("GraduationAudit", graduationPanel);
        ((CardLayout) CardSequencePanel.getLayout()).show(CardSequencePanel, "GraduationAudit");
    }//GEN-LAST:event_jButton10ActionPerformed

    private void jButton11ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton11ActionPerformed
        RegisterationJPanel registrationPanel = new RegisterationJPanel(business, student, CardSequencePanel);
        CardSequencePanel.add("Registration", registrationPanel);
        ((CardLayout) CardSequencePanel.getLayout()).show(CardSequencePanel, "Registration");
    ...
    private void jButton12ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton12ActionPerformed
        ...
        ((CardLayout) CardSequencePanel.getLayout()).show(CardSequencePanel, "Transcript");
