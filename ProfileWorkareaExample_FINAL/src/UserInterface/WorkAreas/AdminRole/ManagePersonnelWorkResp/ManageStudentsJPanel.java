...
public class ManageStudentsJPanel extends javax.swing.JPanel {
    ...
    private void populateFieldsFromSelectedRow() {
        ...
        if (selectedRow != -1 && selectedRow < tableModel.getRowCount()) {
            ...
            Object gpa = tableModel.getValueAt(selectedRow, 5);  // Add this line
            ...
            fieldGPA.setText(gpa != null ? gpa.toString() : "0.00");  // Add this line
    ...
    private void clearFields() {
        ...
        fieldMajor.setText("");
        fieldStatus.setText("");
        fieldGPA.setText("0.00");  // Add this line
        yearComboBox.setSelectedIndex(0);
        fieldPhone.setText("");
    ...
    private boolean validateFields() {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(this, "Please enter a valid GPA (numeric value)", "Validation Error", JOptionPane.ERROR_MESSAGE);
            return false;
        }
    ...
    private void addStudent() {
        ...
        try {
            ...
            double gpa = Double.parseDouble(fieldGPA.getText().trim()); // Get GPA from field
            ...
            // Create new student profile with the entered GPA
    ...
    private void editStudent() {
        ...
        try {
            ...
            // Update student information including GPA
            student.setName(fullName);
            student.setEmail(email);
            student.setMajor(major);
            student.setYear(year);
            student.setGPA(gpa); // Update GPA
