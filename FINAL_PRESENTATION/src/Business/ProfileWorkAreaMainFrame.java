...
public class ProfileWorkAreaMainFrame extends javax.swing.JFrame {
    ...
    private void LoginButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_LoginButtonActionPerformed
        ...
        if (profile instanceof StudentProfile) {
            ...
            CardSequencePanel.removeAll();
            CardSequencePanel.add("StudentWorkArea", studentworkareajpanel);  // ✅ FIXED NAME!
            ((java.awt.CardLayout) CardSequencePanel.getLayout()).show(CardSequencePanel, "StudentWorkArea");  // ✅ SHOW SPECIFIC PANEL!
