...
public class FacultyWorkAreaJPanel extends javax.swing.JPanel {
     ...
     */
    public FacultyWorkAreaJPanel(Business b, JPanel clp, String facultyId) {
        business = b;
    ...
    private void navigateToFacultyProfile() {
        CardSequencePanel.removeAll();

        FacultyProfileJPanel facultyProfile = new FacultyProfileJPanel(business, CardSequencePanel, currentFacultyId);        CardSequencePanel.add("FacultyProfile", facultyProfile);
        ((java.awt.CardLayout) CardSequencePanel.getLayout()).show(CardSequencePanel, "FacultyProfile");
        CardSequencePanel.revalidate();
        CardSequencePanel.repaint();
}

    private void navigateToManageStudentProfiles() {
        CardSequencePanel.removeAll();
        // CHANGE THIS LINE - pass the faculty ID:
        ManageStudentProfilesJPanel manageStudentProfiles = new ManageStudentProfilesJPanel(business, CardSequencePanel, currentFacultyId);
        CardSequencePanel.add("ManageStudentProfiles", manageStudentProfiles);
    ...
    /**
     * Navigate to the Manage Courses panel
     */
    private void navigateToManageCourses() {
        CardSequencePanel.removeAll();
        ManageCoursesJPanel manageCourses = new ManageCoursesJPanel(business, CardSequencePanel);
        CardSequencePanel.add("ManageCourses", manageCourses);
        ((java.awt.CardLayout) CardSequencePanel.getLayout()).show(CardSequencePanel, "ManageCourses");
        CardSequencePanel.revalidate();
        CardSequencePanel.repaint();
    }

   private void navigateToPerformanceReports() {
       CardSequencePanel.removeAll();
       PerformanceReportsJPanel performanceReports = new PerformanceReportsJPanel(business, CardSequencePanel, currentFacultyId);
       CardSequencePanel.add("PerformanceReports", performanceReports);
    ...
    private void jButton10ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton10ActionPerformed
        navigateToManageStudentProfiles();
