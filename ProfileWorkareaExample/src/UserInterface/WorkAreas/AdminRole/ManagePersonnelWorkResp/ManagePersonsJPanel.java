    ...
    private void NextActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_NextActionPerformed
        ...
        try {
            ...
            if (selectedRole.equals("Student")) {
                ...
                FacultyProfile facultyProfile = fd.newFacultyProfile(newPerson);
                facultyProfile.setDepartment("General");
                facultyProfile.setEmployeeId("FAC" + String.format("%03d", fd.getFacultyCount()));
                facultyProfile.setEmail(username + "@university.edu");
                
                newAccount = uad.newUserAccount(facultyProfile, username, password);
                
            } else if (selectedRole.equals("Admin")) {
    // Simple popup dialogs for additional employee info
