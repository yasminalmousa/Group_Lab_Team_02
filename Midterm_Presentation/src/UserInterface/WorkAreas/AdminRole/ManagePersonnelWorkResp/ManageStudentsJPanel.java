...
public class ManageStudentsJPanel extends javax.swing.JPanel {
    ...
    private void populateFieldsFromSelectedRow() {
        ...
        if (selectedRow != -1 && selectedRow < tableModel.getRowCount()) {
            ...
            fieldGPA.setText(gpa != null ? gpa.toString() : "0.00");
        ...
        if (studentDirectory != null) {
            ...
            if (studentList != null) {
                for (StudentProfile student : studentList) {
                    if (student != null) {
                        String gpaString = String.format("%.2f", student.getGPA());
                        String status = "Active"; // Default status
                        String enrollmentDate = "2024-01-01"; // Default enrollment date
                        
                        // Get academic level or default to "Freshman"
                        String academicLevel = student.getAcademicLevel() != null ? 
                            student.getAcademicLevel() : "Freshman";
    ...
    private void addStudent() {
        ...
        try {
            ...
            String academicLevel = yearComboBox.getSelectedItem().toString();
            ...
            Person newPerson = personDirectory.newPersonWithName(fullName);

            // Create new student profile using the proper constructor
            StudentProfile newStudent = studentDirectory.newStudentProfile(newPerson, studentId);
            
            // Set additional student information
            newStudent.setEmail(email);
            newStudent.setMajor(major);
            newStudent.setAcademicLevel(academicLevel);

            // Add some sample courses if this is a new student
            if (newStudent.getCourses().isEmpty()) {
                addSampleCoursesToStudent(newStudent);
            }
    ...
    private void addSampleCoursesToStudent(StudentProfile student) {
        // Add some sample courses for demonstration
        Course cs101 = new Course("CS101", "Introduction to Computer Science", "Fall 2024", 3);
        cs101.setGrade("A");
        student.addCourse(cs101);
        
        Course math201 = new Course("MATH201", "Calculus I", "Fall 2024", 4);
        math201.setGrade("A-");
        student.addCourse(math201);
        
        Course eng101 = new Course("ENG101", "English Composition", "Fall 2024", 3);
        eng101.setGrade("B+");
    ...
    private void editStudent() {
        ...
        try {
            ...
            student.getPerson().setName(fullName); // Update name in Person object
    ...
    private void deleteStudent() {
        ...
        try {
            ...
            if (result == JOptionPane.YES_OPTION) {
                ...
                if (student != null) {
                    studentDirectory.removeStudentProfile(student);
